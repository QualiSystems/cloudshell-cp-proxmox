...
class BaseProxmoxDeployApp(DeployApp):
    ...
    copy_src_uuid = ResourceBoolAttrRODeploymentPath(ATTR_NAMES.copy_src_uuid)
...
class InstanceFromContainerDeployApp(BaseProxmoxDeployApp):
    ...
    DEPLOYMENT_PATH = constants.CONTAINER_FROM_CONTAINER_DEPLOYMENT_PATH
    container_id = ResourceAttrRODeploymentPath(ATTR_NAMES.container_id)
    snapshot = ResourceAttrRODeploymentPath(ATTR_NAMES.snapshot)
